...
app.layout = dbc.Container([
    html.Br(),
    html.Span("Utility Border", className="border border-dark"),  # border-top, border border-danger, border border-3, border rounded-circle
    html.Div("Utility Color", className="text-danger"),  # text-light, bg-success
    html.Div("Utility Opacity", className="opacity-25"),  # opacity-75
    html.Div("Utility Spacing", className="border p-3"),  # m-5, ms-2, my-4, p-3, pb-5
